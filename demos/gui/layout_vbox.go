...
func init() {
	app.DemoMap["gui.layout_vbox"] = &GuiLayoutVBox{}
}

type GuiLayoutVBox struct{}

// Start is called once at the start of the demo.
func (t *GuiLayoutVBox) Start(a *app.App) {
	...
	a.DemoPanel().Add(p1c9)
}

// Update is called every frame.
func (t *GuiLayoutVBox) Update(a *app.App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiLayoutVBox) Cleanup(a *app.App) {}
