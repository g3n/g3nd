...
func init() {
	app.DemoMap["gui.chart"] = &GuiChart{}
}

type GuiChart struct{}

// Start is called once at the start of the demo.
func (t *GuiChart) Start(a *app.App) {
	...
	a.DemoPanel().Add(cbAutoy)

	// Sets chart position and size
	chartY := cbAutoy.Position().Y + cbAutoy.Height() + 10
	chart.SetPosition(0, chartY)
	chart.SetSize(a.DemoPanel().ContentWidth(), a.DemoPanel().ContentHeight()-chartY)
	a.DemoPanel().Subscribe(gui.OnResize, func(evname string, ev interface{}) {
		chart.SetSize(a.DemoPanel().ContentWidth(), a.DemoPanel().ContentHeight()-chartY)
	})
}

// Update is called every frame.
func (t *GuiChart) Update(a *app.App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiChart) Cleanup(a *app.App) {}
