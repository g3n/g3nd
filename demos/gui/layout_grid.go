...
func init() {
	app.DemoMap["gui.layout_grid"] = &GuiLayoutGrid{}
}
...
func (t *GuiLayoutGrid) Start(a *app.App) {
	...
	t.menu.Subscribe(gui.OnMouseDownOut, func(evname string, ev interface{}) {
		t.menu.SetVisible(false)
	})
	...
	a.DemoPanel().Add(t.pan)
}

// Update is called every frame.
func (t *GuiLayoutGrid) Update(a *app.App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiLayoutGrid) Cleanup(a *app.App) {}
