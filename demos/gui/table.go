...
func init() {
	app.DemoMap["gui.table"] = &GuiTable{}
}

type GuiTable struct{}

// Start is called once at the start of the demo.
func (t *GuiTable) Start(a *app.App) {
	...
	mCol.Subscribe(gui.OnMouseDownOut, func(evname string, ev interface{}) {
		mCol.SetVisible(false)
	})
	tab.Add(mCol)
	...
	mRow.Subscribe(gui.OnMouseDownOut, func(evname string, ev interface{}) {
		mRow.SetVisible(false)
	})
	tab.Add(mRow)
...
func (t *GuiTable) Update(a *app.App, deltaTime time.Duration) {}

// Cleanup is called once at the end of the demo.
func (t *GuiTable) Cleanup(a *app.App) {}
