...
func (t *GuiScrollBar) Initialize(app *g3nd.App) {

	// Scroll bar 1
	sb1 := gui.NewHScrollBar(100, 16)
	sb1.SetPosition(10, 10)
	app.GuiPanel().Add(sb1)
	// Position
	l1 := gui.NewLabel("Pos:")
...
func (t *GuiScrollBar) Render(app *g3nd.App) {
}
