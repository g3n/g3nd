...
func init() {
	demos.Map["gui.list"] = &GuiList{}
}

type GuiList struct{}

func (t *GuiList) Initialize(app *g3nd.App) {
...
func (t *GuiList) Render(app *g3nd.App) {
}
